        ...
        def attn_between_items(x: torch.Tensor) -> torch.Tensor:
            ...
            if self.multiquery_item_attention_for_test_set:
                if single_eval_pos < x.shape[1]:
                    self.self_attn_between_items._attn_is_cross = True   # [MIA-ADDED]
                ...
                if single_eval_pos:
                    self.self_attn_between_items._attn_is_cross = False  # [MIA-ADDED]
                ...
                self.self_attn_between_items._attn_is_cross = None       # [MIA-ADDED] reset
